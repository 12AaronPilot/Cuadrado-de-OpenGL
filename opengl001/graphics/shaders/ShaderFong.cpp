#include "ShaderFong.h"
#include <fstream>
#include <vector>

using namespace std;

CShaderFong::CShaderFong()
{
}
...
void CShaderFong::initializeParticularShader()
{
...
GLuint CShaderFong::getShaderBuffer(eBufferType bufferType)
{
	switch (bufferType)
	{
